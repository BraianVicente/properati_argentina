...
#API_KEY = 'YOUR_API_KEY'                            # Put your API key here, see https://console.developers.google.com
from private_API_KEY import API_KEY
...
class GoogleStaticMapsAPI:
    ...
    def map(
            ...
            maptype=MAPTYPE, file_format='jpg', markers=None):
